...
See `docs/cookbook.md` for a full feature end-to-end, `docs/migration.md` for migrating legacy projects (JS→TS + adopting MEDA UI), `docs/i18n.md` for translations (mock → 3 layers → test → review), and `docs/development-examples.md` for before/after code showing how the principles shape day-to-day
