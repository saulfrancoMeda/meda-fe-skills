 ...
 * currentColor so it adapts to light/dark (pass text-fg or text-white via className).
 */
export function MedaLogo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 160 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="MEDA">
